...
public class FileHandler implements ActionListener {
	...
	public static treeMapSort theInput = new treeMapSort(); // calls out the treeMapSort
	public static TreeMap<Word, Word> treeMap = theInput.getWordMap();
	...
	public static void taskManage() {
		...
		// String line = input.readLine().replaceAll("[|;:,'\"]", " "); // Take the first line from the input
